...
void ApplicationFunctionSet::ApplicationFunctionSet_SensorDataUpdate(void)
{
  ...
  { /*value updation for the IR sensors on the line tracking module：for the line tracking mode*/
    ...
    // Serial.print(" | L_in=");
    // Serial.print(TrackingDetectionStatus_L);
    // Serial.print(" M_in=");
    // Serial.print(TrackingDetectionStatus_M);
    // Serial.print(" R_in=");
...
// // ---- 1) Shared sensor update: call this from ANY mode that needs edge detection ----
// void ApplicationFunctionSet::UpdateTrackingSensors(void)
// {
//   // These were commented out in your Tracking() function.
//   // Make them the single source of truth for TrackingData_*.
//   TrackingData_L = AppITR20001.DeviceDriverSet_ITR20001_getAnaloguexxx_L();
//   TrackingData_M = AppITR20001.DeviceDriverSet_ITR20001_getAnaloguexxx_M();
//   TrackingData_R = AppITR20001.DeviceDriverSet_ITR20001_getAnaloguexxx_R();
...
//     Serial.print(TrackingDetection_E);
//     Serial.print(" | L_in=");
//     Serial.print(function_xxx(TrackingData_L, TrackingDetection_S, TrackingDetection_E));
//     Serial.print(" M_in=");
//     Serial.print(function_xxx(TrackingData_M, TrackingDetection_S, TrackingDetection_E));
//     Serial.print(" R_in=");
//     Serial.println(function_xxx(TrackingData_R, TrackingDetection_S, TrackingDetection_E));
// }
